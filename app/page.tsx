...
const Home = () => {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>Sales Analytics Dashboard | {businessName}</title>
        <meta name="title" content={`Sales Analytics Dashboard | ${businessName}`} />
        <meta name="description" content={`View real-time sales analytics, revenue metrics, product performance, and business insights for ${businessName}. Track hourly, daily, and monthly sales trends.`} />
        <meta name="keywords" content="sales analytics, business dashboard, revenue tracking, product sales, business intelligence, sales metrics, business performance" />
        <meta name="author" content="Your Company Name" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        
        {/* Canonical URL */}
        <link rel="canonical" href={`${process.env.NEXT_PUBLIC_HOST}/dashboard`} />
        
        {/* Language Alternates */}
        <link rel="alternate" hrefLang="en" href={`${process.env.NEXT_PUBLIC_HOST}/en/dashboard`} />
        <link rel="alternate" hrefLang="sw" href={`${process.env.NEXT_PUBLIC_HOST}/sw/dashboard`} />
        <link rel="alternate" hrefLang="x-default" href={`${process.env.NEXT_PUBLIC_HOST}/dashboard`} />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${process.env.NEXT_PUBLIC_HOST}/dashboard`} />
        <meta property="og:title" content={`Sales Analytics Dashboard | ${businessName}`} />
        <meta property="og:description" content={`Comprehensive sales analytics dashboard for ${businessName}. Track revenue, monitor product performance, and gain actionable business insights.`} />
        <meta property="og:image" content={`${process.env.NEXT_PUBLIC_HOST}/og-dashboard-image.jpg`} />
        <meta property="og:site_name" content="Your Business Analytics Platform" />
        <meta property="og:locale" content={language === "Swahili" ? "sw_TZ" : "en_US"} />
        <meta property="og:locale:alternate" content="en_US" />
        <meta property="og:locale:alternate" content="sw_TZ" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content={`${process.env.NEXT_PUBLIC_HOST}/dashboard`} />
        <meta property="twitter:title" content={`Sales Analytics Dashboard | ${businessName}`} />
        <meta property="twitter:description" content={`Real-time sales analytics and business insights for ${businessName}. Track key metrics and performance indicators.`} />
        <meta property="twitter:image" content={`${process.env.NEXT_PUBLIC_HOST}/twitter-dashboard-image.jpg`} />
        
        {/* Additional SEO Tags */}
        <meta name="application-name" content="Business Analytics Platform" />
        <meta name="apple-mobile-web-app-title" content="Sales Dashboard" />
        <meta name="theme-color" content="#482691" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": `Real-time sales analytics dashboard for ${businessName}`,
              "url": `${process.env.NEXT_PUBLIC_HOST}/dashboard`,
              ...
              "inLanguage": language === "Swahili" ? "sw" : "en",
              "softwareVersion": "1.0.0"
            })
          }}
        />
        
        {/* Business Schema (if applicable) */}
        {selected?.name && (
          <script
            type="application/ld+json"
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "logo": `${process.env.NEXT_PUBLIC_HOST}/logo.png`,
                "description": `Business analytics dashboard for ${selected.name}`,
                "address": `${selected.street,selected.ward,selected.district,selected.city,selected.country}`
              })
            }}
          />
        )}
